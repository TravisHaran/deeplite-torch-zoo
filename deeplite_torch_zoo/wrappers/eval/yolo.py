...
from deeplite_torch_zoo.src.objectdetection.eval.coco.coco_evaluator import yolo_eval_coco, yolo_eval_coco_foot
...
__all__ = ["get_eval_func", "yolo_eval_coco", "yolo_eval_coco_foot", "yolo_eval_voc", "yolo_eval_lisa", "yolo_eval_wider_face"]
